...
const REVIEWERS = [
  {
    ...
    examDetails: {
      ...
      bannerImage: null,
      coverage: [
        { subject: "Verbal Ability", itemCount: "51 items", topics: ["Word Meaning", "Sentence Completion", "Error Recognition", "Sentence Structure", "Paragraph Organization", "Reading Comprehension"] },
        { subject: "Analytical Ability", itemCount: "60 items", topics: ["Word Analogy", "Symbolic Logic / Abstract Reasoning", "Identifying Assumption and Drawing Conclusion", "Data Interpretation"] },
        { subject: "Numerical Ability", itemCount: "51 items", topics: ["Basic Operations", "Number Sequence", "Word Problems"] },
        { subject: "General Information", itemCount: "8 items", topics: ["Philippine Constitution", "Code of Conduct and Ethical Standards for Public Officials and Employees (R.A. 6713)", "Peace and Human Rights Issues and Concepts", "Environment Management and Protection"] },
      ],
      breakdownFootnote: "Coverage aligned to CSC scope. Item distribution may vary in the actual exam.",
      disclaimer: "This mock exam is designed to closely simulate the format and difficulty of the Civil Service Exam but does not guarantee identical questions, coverage, or results in the actual examination.",
      difficultyText: "Difficulty varies per section, similar to the actual Civil Service Exam.",
      importantNotes: [
        { title: "⏱️ Time Management is Key", text: "This mock exam is strictly timed at 3 hours and 10 minutes. Pacing yourself is crucial!" },
        { title: "❌ No \"Negative Marking\"", text: "Don't be afraid to guess! There's no deduction for wrong answers, so try to answer all questions." },
        { title: "💡 You can skip questions", text: "Feel free to skip difficult questions and come back to them later if you have time." },
        { title: "✅ Review your answers", text: "Once you finish, our system will immediately show your score and a detailed breakdown of your performance per subject area. You can also review your answers with explanations." },
        { title: "🧠 Heads up!", text: "All questions in this mock exam are uniquely generated by Reviewly's advanced AI to give you fresh challenges every time." },
      ],
    },
  },
  {
    ...
    examConfig: {
      ...
      sectionDistribution: [
        ...
        { section: "clerical", count: 58 },
        { section: "numerical", count: 49 },
        { section: "general information", count: 8 },
      ],
      difficultyDistribution: { easy: 30, medium: 50, hard: 20 },
    },
    examDetails: {
      ...
      bannerImage: null,
      coverage: [
        { subject: "Verbal Ability", itemCount: "50 items", topics: ["Word Meaning", "Sentence Completion", "Error Recognition", "Sentence Structure", "Paragraph Organization", "Reading Comprehension"] },
        { subject: "Clerical Ability", itemCount: "58 items", topics: ["Filing", "Spelling"] },
        { subject: "Numerical Ability", itemCount: "49 items", topics: ["Basic Operations", "Number Sequence", "Word Problems"] },
        { subject: "General Information", itemCount: "8 items", topics: ["Philippine Constitution", "Code of Conduct and Ethical Standards for Public Officials and Employees (R.A. 6713)", "Peace and Human Rights Issues and Concepts", "Environment Management and Protection"] },
      ],
      breakdownFootnote: "Coverage aligned to CSC scope. Item distribution may vary in the actual exam.",
      disclaimer: "This mock exam is designed to closely simulate the format and difficulty of the Civil Service Exam but does not guarantee identical questions, coverage, or results in the actual examination.",
      difficultyText: "Difficulty varies per section, similar to the actual Civil Service Exam.",
      importantNotes: [
        { title: "⏱️ Time Management is Key", text: "This mock exam is strictly timed at 2 hours and 40 minutes. Pacing yourself is crucial!" },
        { title: "❌ No \"Negative Marking\"", text: "Don't be afraid to guess! There's no deduction for wrong answers, so try to answer all questions." },
        { title: "💡 You can skip questions", text: "Feel free to skip difficult questions and come back to them later if you have time." },
        { title: "✅ Review your answers", text: "Once you finish, our system will immediately show your score and a detailed breakdown of your performance per subject area. You can also review your answers with explanations." },
        { title: "🧠 Heads up!", text: "All questions in this mock exam are uniquely generated by Reviewly's advanced AI to give you fresh challenges every time." },
...
async function seed() {
  ...
  console.log("🗑  Clearing existing reviewers...");
